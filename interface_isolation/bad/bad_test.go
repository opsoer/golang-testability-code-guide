...
func (o *Operate) SetInitVal(i int) {
	o.num = i
}

func (o *Operate) Add(i int) {
	o.num += i
}

func (o *Operate) Subtract(i int) {
	o.num -= i
}

func (o *Operate) Multiply(i int) {
	o.num *= i
}

func (o *Operate) Divide(i int) {
...
func (o *Operate) Result() int {
	return o.num
}

func TestBasicCase(t *testing.T) {
	op := new(Operate)
	basic := Basic{op, 1, 2, 3}
	// 1+2-3 = 0
	ret := basic.Computer()
	if 0 != ret {
